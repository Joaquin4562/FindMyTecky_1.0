...
class MapaPage extends StatefulWidget {
  ...
  final LatLng choferTecky = LatLng(22.7334853, -98.9574801);
...
class _MapaPageState extends State<MapaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    ///Atrae el CenterView que es acomodar los markers
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ///Todas las variables del GoogleMaps
          GoogleMap(
          ...
          Positioned(
            ...
            ///Icono del Marker
              ...
              ///Agrega el marker del estudiante y el tecky
              temporal.add(
              Marker(
